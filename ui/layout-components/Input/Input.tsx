      ...
      <If condition={success && !error}>
        <div className="icon">
          ...
          >
            ...
            />
            <path
              d="M18.5113 3.35254L10.178 11.6942L7.67798 9.1942"
              stroke="#0BB07B"
              strokeWidth="1.8"
              strokeLinecap="round"
              strokeLinejoin="round"
        ...
        <div className="icon">
          ...
          >
            <g clipPath="url(#clip0_291_299)">
              <path
                d="M10.168 18.349C14.7703 18.349 18.5013 14.6181 18.5013 10.0157C18.5013 5.41333 14.7703 1.68237 10.168 1.68237C5.56559 1.68237 1.83463 5.41333 1.83463 10.0157C1.83463 14.6181 5.56559 18.349 10.168 18.349Z"
                stroke="#F03D3D"
                strokeWidth="1.8"
                strokeLinecap="round"
                strokeLinejoin="round"
            ...
            <defs>
              <clipPath id="clip0_291_299">
                <rect
                  ...
                  height="20"
                  fill="white"
                  transform="translate(0.167969 0.015625)"
                />
              </clipPath>
            </defs>
          </svg>
